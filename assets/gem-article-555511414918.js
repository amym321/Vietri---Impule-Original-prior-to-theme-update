...
(function( jQuery ){
  var $module = jQuery('#m-1620220918735').children('.module');
  ...
  setTimeout(function() {
    ...
    videoWrapper.empty().append('<div id="vimeo-wrapper-1620220918735"></div>');
    ...
    var player = new Vimeo.Player("vimeo-wrapper-1620220918735", options);
